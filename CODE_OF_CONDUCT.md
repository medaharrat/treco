...
We as members, contributors, and maintainers pledge to make participation in the Treco project a harassment-free
...
As Treco is currently maintained by a single individual developer rather than a team, enforcement decisions rest with
that maintainer. This may change as the project grows.

## Scope

This Code of Conduct applies within all project spaces (GitHub issues, pull requests, discussions) and in public
spaces when an individual is representing the project.
