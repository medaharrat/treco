...
export function PrivacyPage() {
  return (
    <div>
      ...
      <Card>
        <h2 className="af-h2">What Treco never does</h2>
        <ul style={{ fontSize: 13.5, lineHeight: 1.9, paddingLeft: 20 }}>
          ...
          <li>Never sends any data to Treco's own servers - because it has none. Everything runs on your device.</li>
      ...
      <Card>
        ...
        <p style={{ fontSize: 13.5 }}>
          On pages belonging to AI products you've explicitly enabled, Treco's content script observes the page's DOM to
      ...
      <Card>
        ...
        <p style={{ fontSize: 13.5 }}>
          ...
          Treco server, because none exists. You can export everything as JSON or CSV, or delete it permanently, at any
          time from Settings.
        </p>
      </Card>
      ...
      <Card>
        ...
        <p style={{ fontSize: 13.5 }}>
          Because Treco never reads conversation content beyond a text-length measurement, its token counts are estimates
